...
cv2.imwrite('HW1_IMG_CS898BA_normalized.png', image_norm) # save normalized image
...
cv2.imwrite('HW1_IMG_CS898BA_mask_otsu.png', mask_otsu)
cv2.imwrite('HW1_IMG_CS898BA_mask_adaptive.png', mask_adapt)
...
cv2.imwrite('HW1_IMG_CS898BA_mask_kmeans.png', mask_kmeans) # save k-means mask